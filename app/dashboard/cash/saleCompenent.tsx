...
const SaleComponent = ({
    ...
    handlePaymentMethod,
    createSale,
    error,      // الرسالة القادمة من السيرفر
    loading,
    success
}: {
    sale: Sale,
    ...
    createSale: () => void,
    error?: string | null, // إضافة تعريف النوع للخطأ
    loading?: boolean,
    success?: boolean
}) => {
    ...
    return (
        <div className="flex flex-col h-full bg-white border-l border-gray-200 shadow-lg w-full max-w-md mx-auto relative">
            ...
            {/* عرض الخطأ في حال وجوده - يظهر تحت الرأس مباشرة */}
            {error && (
                <div className="mx-4 mt-4 p-3 bg-red-50 border border-red-200 text-red-700 rounded-lg flex items-start gap-2 animate-in fade-in slide-in-from-top-2">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
                {sale.items.map((item, index) => (
                    <div key={index} className="flex items-center justify-between bg-gray-50 p-3 rounded-lg border border-gray-100 group transition-all">
            ...
            <div className="p-4 bg-gray-50 border-t">
                ...
                <div className="grid grid-cols-2 gap-2">
                    <button
                        ...
                        className={`flex items-center justify-center gap-2 py-2 rounded-md border-2 transition-all ${sale.paymentMethod === 'cash'
                    ...
                    <button
                        ...
                        className={`flex items-center justify-center gap-2 py-2 rounded-md border-2 transition-all ${sale.paymentMethod === 'card'
                            ? 'border-blue-600 bg-blue-50 text-blue-600'
                            : 'border-gray-200 text-gray-400'
                            }`}
                    >
            ...
            {/* المجموع النهائي والدفع */}
            <div className="p-4 bg-gray-900 text-white shadow-inner">
